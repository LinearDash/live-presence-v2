...
export default function UserSidebar({ user, onClose, onMessage }: UserSidebarProps) {
    ...
    <div className="w-96 bg-card border-l border-border h-screen overflow-y-auto shadow-xl flex flex-col z-50 fixed right-0 top-0">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        <div className="pt-4 border-t border-border">
          <button
            onClick={onMessage}
            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-primary/10 hover:bg-primary/20 text-primary rounded-lg transition-colors font-semibold"
          >
